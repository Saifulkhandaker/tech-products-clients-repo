          ...
          <div>
           ...
           <div className="flex justify-self-end gap-10">
            <div className="flex items-center gap-5">
                <button className="btn bg-white border-green-600 rounded-lg" onClick={handleVote} disabled={hasVoted}>Up Vote</button>
                <p className="text-2xl flex items-center gap-2 text-green-900 font-medium"><MdWhereToVote className="mt-1" />{totalVotes}</p>
            </div>
            <div className="flex items-center gap-5">
                <button className="btn bg-white border-red-800 rounded-lg" onClick={handleReport} disabled={hasReported}>Report</button>
                <p className="text-2xl flex items-center gap-2 text-red-900 font-medium"><MdOutlineReport className="mt-1" />{totalReports}</p>
            </div>
           </div>
        </div>
    </div>
